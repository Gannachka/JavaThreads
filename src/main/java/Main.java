...
public class Main {
    ...
    public static void OptionalTask() {
        ...
        File fileWithRandomNumbers = new File("D:/Output/fileWithRandomNumbers.txt");
        ...
        //Fifth task
        File studentsFile = new File("D:/Output/students.txt");
        File studentsFileOutput = new File("D:/Output/studentsOutput.txt");
        try {
